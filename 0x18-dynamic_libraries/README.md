The project is about dynamic libraries, how they work, how to create and use one It involves understanding environment variable $LD_LIBRARY_PATH and its use The basic usage of nm, ldd, ldconfig
